        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 max-w-4xl mx-auto">
            <div className="text-center space-y-3">
              ...
              <h3 className="font-semibold">{t('realTimeTracking')}</h3>
              <p className="text-sm text-muted-foreground">{t('realTimeTrackingDesc')}</p>
            </div>
            <div className="text-center space-y-3">
              <div className="w-12 h-12 bg-accent/10 rounded-lg flex items-center justify-center mx-auto">
                <Clock className="w-6 h-6 text-accent" />
              </div>
              <h3 className="font-semibold">{t('smartSchedules')}</h3>
              <p className="text-sm text-muted-foreground">{t('smartSchedulesDesc')}</p>
            </div>
            <div className="text-center space-y-3">
              ...
              <h3 className="font-semibold">{t('routeOptimization')}</h3>
              <p className="text-sm text-muted-foreground">{t('routeOptimizationDesc')}</p>
            </div>
          </div>
        </div>
      </div>
